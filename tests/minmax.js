...
QUnit.module('Тестируем функцию minmax', function () {
	...
	QUnit.test('minmax проверяет валидность данных', function(assert){
		assert.deepEqual(minmax(129), [undefined, undefined]);
		assert.deepEqual(minmax(846), [undefined, undefined]);
	});
});
